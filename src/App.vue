        ...
        <div class="navbar-menu">
          <div class="navbar-start">
            <div class="navbar-item">
              <router-link to="/admin" class="button is-white" exact>Admin</router-link>
            </div>
          </div>
          <div class="navbar-end">
            <div class="navbar-item">
              <router-link to="/cart" class="button is-white"><i class="material-icons" exact>shopping_cart</i></router-link>
            </div>
          </div>
        </div>
      </div>
